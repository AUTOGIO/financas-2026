# Technical & Executive Report — Personal Finance System (ARCHIVED)
## [REDACTED] · H1 2026

> **Status:** ARCHIVED 2026-07-29 — superseded by `docs/technical-report-2026-07.md`.
> This copy describes the **pre-reorganization** repository layout
> (`nfce/`, `html/`, `banco_inter/`, etc.) and predates the AUDIT-001 PII
> redaction pass. All commands and file paths inside are stale — do not
> follow them. Kept only for historical reference. See AUDIT-004.
>
...
cd $HOME/Documents/GitHub/financas-2026/nfce
...
cp -r ~/Downloads/NFCE_XML_NEWEXPORT \
      $HOME/Documents/GitHub/financas-2026/nfce/notas/
...
open $HOME/Documents/GitHub/financas-2026/html/bloomberg-terminal.html
...
open $HOME/Documents/GitHub/financas-2026/nfce/personal_inflation_index.html
...
```bash
cd $HOME/Documents/GitHub/financas-2026
...
|---|---|---|---|
| **Jul 14–20** | Cancel Claude×2 + Grok + TuneIn via Apple Subscriptions | +R$ 4,390/yr | [REDACTED] |
| **Jul 14–20** | Confirm IB withdrawal R$19,196 destination | Reconciliation | [REDACTED] |
| **Jul 21–31** | Pull USD account statement — reconcile 19 BCB ops | Reconciliation | [REDACTED] |
| **Jul 21–31** | Set R$500/month Loteria cap via MP card limit | −R$ 575/mo avg | [REDACTED] |
| **Aug 1–15** | Audit 6 REVIEW subscriptions → decide KEEP or CANCEL | +R$ 2,700/yr | [REDACTED] |
| **Aug 1–15** | Tag ML/iFood orders: CAPEX / HEALTH / CONSUMABLE | Tax/tracking | [REDACTED] |
| **Aug 1–15** | Classify LAN Airlines trip: business vs personal | Tax/deductibility | [REDACTED] |
| **Aug 31** | Increase liquid buffer to minimum R$30,000 | Security | [REDACTED] |
| **Sep 30** | Download new BCB Registrato (next quarterly update) | Compliance | [REDACTED] |
| **Oct 2026** | Full H2 review — rebuild CALC with new 6 months of data | — | [REDACTED] |
...
| Git | Repo root at `$HOME/Documents/GitHub/financas-2026/` |
| nfce sub-repo | `$HOME/Documents/GitHub/financas-2026/nfce/` (separate `.git`) |
